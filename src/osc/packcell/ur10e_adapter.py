...
PICK=(.52,0.,.78); CARTON=(.34,-.32,.77); CARTON_INTERIOR=(.32,.24,.20)
...
class UR10eAdapter(RobotArmAPI):
    def __init__(self,support_lip=True,telemetry=False):
